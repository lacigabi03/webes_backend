...
(32, 'Alma', '', 'photo_1706864700667_photo.jpg', '', 1),
...
--
ALTER TABLE `erdekessegek`
  MODIFY `erd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT a táblához `nevezetessegek`
--
ALTER TABLE `nevezetessegek`
  MODIFY `Nevezetesseg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `orszag`
  MODIFY `Orszag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
